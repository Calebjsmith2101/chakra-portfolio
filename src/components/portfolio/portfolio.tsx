...
const portfolio = () => {
  return (
    ...
    <Box id='portfolio' pt="130px">
      <Heading as='h1' size='4xl' noOfLines={1} color="brand.100" ml={['110','', '450']} pb="50px" >Portfolio</Heading>
      <Box>
        <HStack spacing='24px' ml={['75','65', '210']} mr={['75','65', '210']} pb="50px">
        <Box as="article" w='250px' h='250px'>
          ...
          <Heading as='h5' size='sm' color="brand.100" pb='0px' fontSize={['xs', 'xs', 'lg']}>Birthday Reminder</Heading>
          <Link href="https://github.com/Calebjsmith2101/birthday-reminder" 
                isExternal
                display="inline-block"
                color="#42A799"
                padding={['0.2rem 0.5rem','0.2rem 0.5rem', '0.5rem 1rem']}
                border="1px solid"
                borderRadius='xl'
                m={3}>Github</Link>
          <Link href="https://react-projects-1-birthday-reminder.netlify.app/" 
                ...
                border="1px solid"
                borderRadius='xl'
                bg="#42A799" fontSize={['sm', 'sm', 'lg']}>Live Demo</Link>
        </Box> 
        <Box as="article" w='250px' h='250px'>
          ...
          <Heading as='h5' size='sm' color="brand.100" pb='10px' fontSize={['xs', 'xs', 'lg']}>Our Tours</Heading>
        ...
        <Box as="article" w='250px' h='250px'>
          ...
          <Heading as='h5' size='sm' color="brand.100" pb='10px' fontSize={['xs', 'xs', 'lg']}>Our Reviews</Heading>
        ...
        <HStack spacing='24px' pb="50px" ml={['75','65', '210']} mr={['75','65', '210']}>
        <Box as="article" w='250px' h='250px'>
          ...
          <Heading as='h5' size='sm' color="brand.100" pb='10px' fontSize={['xs', 'xs', 'lg']}>Accordion</Heading>
        ...
        <Box as="article" w='250px' h='250px'>
          ...
          <Heading as='h5' size='sm' color="brand.100" pb='10px' fontSize={['xs', 'xs', 'lg']}>Our Menu</Heading>
        ...
        <Box as="article" w='250px' h='250px'>
          <Image src='https://calebjsmith.netlify.app/static/media/portfolio6.1168bce3da171edad5ff.jpg' 
           alt='Our Reviews'borderRadius='10%'pb='10px'/>
          <Heading as='h5' size='sm' color="brand.100" pb='10px' fontSize={['xs', 'xs', 'lg']}>Experience</Heading>
          ...
          <Link href="https://react-projects-6-tabs.netlify.app/" 
                ...
                display="inline-block"
                color="brand.200"
                p={['0.2rem 0.5rem','0.2rem 0.5rem', '0.5rem 1rem']}
                border="1px solid"
                borderRadius='xl'
                bg="#42A799" fontSize={['sm', 'sm', 'lg']}>Live Demo</Link>
        </Box> 
